...
for j, scene in enumerate(scenes):
    ...
    real_scene = os.listdir(RECEIVED + '')
    ...
    for i, file in enumerate(files):
        ...
        meta2 = os.path.join(os.path.join(RECEIVED, scene.split('__', 1)[1], \
                                'sensor_info_cam[1]_req_[' + file.split('req[')[1].split(']')[0] + '].txt'  ))    
        ...
        # print(glob.glob(os.path.join(RECEIVED, scene.split('__', 1)[1] , 'awb_output_*_req_*' + file.split('req[')[1].split(']')[0] + '*.txt'  )))   
        # print(glob.glob(os.path.join(RECEIVED, scene.split('__', 1)[1], 'sensor_info_*_req_*' + file.split('req[')[1].split(']')[0] + '*.txt' ))) 
        # exit(0)
        # assert len(glob.glob(os.path.join(RECEIVED, scene.split('__', 1)[1] , 'awb_output_*_req_*' + file.split('req[')[1].split(']')[0] + '*.txt'  ))) == 1    
        # assert len(glob.glob(os.path.join(RECEIVED, scene.split('__', 1)[1], 'sensor_info_*_req_*' + file.split('req[')[1].split(']')[0] + '*.txt' ))) == 1
