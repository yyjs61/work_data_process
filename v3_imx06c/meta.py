...
def main():
    ...
    for unpack_scene in unpack_scenes:
        ...
        print(f"  找到 {len(all_txt_files)} 个txt文件映射")
        ...
        for idx, raw_file in enumerate(raw_files):
            ...
            yaml_data = {
                ...
                'r_gain': meta_data.get('awbRGain', 1.0),
                'b_gain': meta_data.get('awbBGain', 1.0),
                # 'r_gain': float(r_gain),
                # 'b_gain': float(b_gain),
            }
